...
@Component({
  selector: 'ttkt-loai-bc-linhvuc-tw',
  templateUrl: './loai-bc-linhvuc-tw.component.html',
  styleUrls: ['./loai-bc-linhvuc-tw.component.scss']
})
export class LoaiBcLinhvucTwComponent implements OnInit {
