...
@Component({
  selector: 'ttkt-taomoi-so-tonghop-kq',
  templateUrl: './taomoi-so-tonghop-kq.component.html',
  styleUrls: ['./taomoi-so-tonghop-kq.component.scss']
})
export class TaomoiSoTonghopKqComponent implements OnInit {
  ...
  closeTaoMoiSoTongHopKQ() {
    this.router.navigate(['/ql-hd-ttkt/ql-baocao-ttkt/tinh/so-tonghop-kq']);
  }
